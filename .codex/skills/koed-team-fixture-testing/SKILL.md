...
description: Test Koed Team SaaS backend, API, recall, graph, evidence, Agent workflow, or Electron behavior against the deterministic Team SaaS synthetic memory fixture. Use when validating KOE-245 fixture data, KOE-227 launch validation work, Team Workspace authorization, shared memory visibility, revoked/private memory boundaries, retained Team knowledge, or UI flows that should match the fixture truth sheet.
---
...
2. Run or request the appropriate fixture command:
   ...
   - `pnpm team-fixture:reset` to remove only fixture rows and return to square
     1.
3. Use the truth sheet to build API, repository, recall, graph, expansion,
   evidence, Agent, or Electron checks.
...
3. Team recall/search: authorized users see only shared, active, retained
   Workspace memory.
