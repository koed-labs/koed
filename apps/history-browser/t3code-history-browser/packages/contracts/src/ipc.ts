...
export type KoedMemoryRetrievalScope = "personal" | "personal+team";
export type KoedMemorySearchDomain = "session" | "project" | "global";

export const KoedMemoryRetrievalScopeSchema = Schema.Literals(["personal", "personal+team"]);
export const KoedMemorySearchDomainSchema = Schema.Literals(["session", "project", "global"]);

export interface KoedMemoryAnswerInput {
  query: string;
  retrieval_scope: KoedMemoryRetrievalScope;
  search_domain: KoedMemorySearchDomain;
  workspace_id?: string;
  session_id?: string;
  limit?: number;
}

export const KoedMemoryAnswerInputSchema = Schema.Struct({
  query: Schema.String,
  retrieval_scope: KoedMemoryRetrievalScopeSchema,
  search_domain: KoedMemorySearchDomainSchema,
  workspace_id: Schema.optionalKey(Schema.String),
  session_id: Schema.optionalKey(Schema.String),
  limit: Schema.optionalKey(Schema.Number),
});

export type KoedMemoryAnswerResult = Record<string, unknown>;
export const KoedMemoryAnswerResultSchema = Schema.Record(Schema.String, Schema.Unknown);
...
export interface DesktopBridge {
  ...
  koedMemoryAnswer?: (input: KoedMemoryAnswerInput) => Promise<KoedMemoryAnswerResult>;
