...
the expired one. The activation read itself requires fresh authentication, so
a stale session must show sign-in before actionable approval controls. Once
...
|  14 | Share Memory with a Workspace                  | Memory Events: Step-up. LCM Leaves/Rollups: Native review. Unknown representation: fail closed. | One exact final decision activates any reviewed owner-policy proposal and binds consent plus Share Grant creation. Preview remains Direct. | Automated boundary: Direct read-only preview, both final tier branches, exact combined review, policy activation, consent, grant creation, replay, and rollback cases pass. Live rerun pending for the updated one-review flow.                                                                                                                                                                                                             | Automated |
