...
const localServiceEnv = (
  ...
  return {
    ...
    TEAM_MEMORY_DATA_ENCRYPTION_KEY:
      environment.TEAM_MEMORY_DATA_ENCRYPTION_KEY ??
      repoEnv.TEAM_MEMORY_DATA_ENCRYPTION_KEY,
    TEAM_MEMORY_ENVELOPE_ENCRYPTION_PROVIDER:
      environment.TEAM_MEMORY_ENVELOPE_ENCRYPTION_PROVIDER ??
      repoEnv.TEAM_MEMORY_ENVELOPE_ENCRYPTION_PROVIDER,
    TEAM_MEMORY_MANAGED_KMS_KEY_ID:
      environment.TEAM_MEMORY_MANAGED_KMS_KEY_ID ??
      repoEnv.TEAM_MEMORY_MANAGED_KMS_KEY_ID,
    TEAM_MEMORY_MANAGED_KMS_KEY_VERSION:
      environment.TEAM_MEMORY_MANAGED_KMS_KEY_VERSION ??
      repoEnv.TEAM_MEMORY_MANAGED_KMS_KEY_VERSION,
    TEAM_MEMORY_MANAGED_KMS_ENDPOINT_URL:
      environment.TEAM_MEMORY_MANAGED_KMS_ENDPOINT_URL ??
      repoEnv.TEAM_MEMORY_MANAGED_KMS_ENDPOINT_URL,
    TEAM_MEMORY_MANAGED_KMS_AUTH_TOKEN:
      environment.TEAM_MEMORY_MANAGED_KMS_AUTH_TOKEN ??
      repoEnv.TEAM_MEMORY_MANAGED_KMS_AUTH_TOKEN,
