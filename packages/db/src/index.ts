...
export {
  ...
  type CollaborationSharedMemoryCanonicalSourceItem,
...
export {
  ...
  PrivacyClassificationConflictError,
  ...
  type DecryptedPrivacySanitizedSourceArtifact,
  type DecryptedPrivacySanitizedSourceChunk,
  type EffectivePrivacyContentPolicy,
  type PrivacyClassificationRepository,
  type PrivacyClassificationResultRecord,
  type PrivacyClassifierGenerationRecord,
  type PrivacyClassifierGenerationStatus,
  type PrivacyContentPolicyRecord,
  type PrivacyContentPolicyScope,
  type PrivacyContentPolicyStatus,
  type PrivacyContentPolicySubject,
  type PrivacySanitizedSourceArtifactRecord,
  type PrivacySanitizedSourceChunkRecord,
  type PrivacySanitizedSourceManifest
...
export {
  ...
  type SharedMemorySanitizedSemanticPreviewPayload,
  type SharedMemorySemanticCandidate,
  type SharedMemorySemanticEmbeddingSourceBinding,
  type SharedMemorySemanticPreviewRecord,
  type SharedMemorySemanticPrivacyClaim,
  type SharedMemorySemanticPrivacyBacklogDiagnostics,
  type SharedMemorySemanticPrivacyFinalizationLease,
  type SharedMemorySemanticClassificationChunkRecord,
  type SharedMemorySemanticPreviewStatus,
  ...
  type SharedMemoryFidelityChangeReviewRecord,
