...
export const promptFileNames = {
  ...
  "ai-client-memory-answer-base": "ai-client/memory-answer-base.md",
  "ai-client-memory-answer-developer": "ai-client/memory-answer-developer.md",
  "ai-client-worker-developer": "ai-client/worker-developer.md",
  "ai-client-lcm-summary-base": "ai-client/lcm-summary-base.md",
  "ai-client-session-title-base": "ai-client/session-title-base.md",
  "ai-client-eval-base": "ai-client/eval-base.md",
...
export const requiredPromptPlaceholders = {
  ...
  "ai-client-lcm-summary-base": [],
  "ai-client-session-title-base": [],
  "ai-client-eval-base": [],
